...
class FFmpegEngineer:
    ...
    def complete(self, prompt, model=config.get('model', 'gpt-3.5'), api_key=""):
    ...
    def chat_with_gpt(self, prompt, model=config.get('model', 'gpt-3.5'), api_key=""):
...
if __name__ == "__main__":
    ...
    eng.complete(prompt, model=config.get('model', 'gpt-3.5'), api_key=OPENAI_KEY)
